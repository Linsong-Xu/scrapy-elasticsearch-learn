...
redis_cli = redis.StrictRedis(host="localhost",charset="utf8",decode_responses=True)
...
class JobBoleArticleItem(scrapy.Item):
    ...
    def get_insert_sql(self):
        insert_sql = 'insert into jobbole_article(title, url, url_object_id, front_image_url, front_image_path, create_date, comment_nums, fav_nums, praise_nums, tags, content) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s) ON DUPLICATE KEY UPDATE comment_nums=VALUES(comment_nums), fav_nums=VALUES(fav_nums), praise_nums=VALUES(praise_nums)'
        params = (self['title'], self['url'], self['url_object_id'], self['front_image_url'][0], self['front_image_path'], self['create_date'], self['comment_nums'], self['fav_nums'], self['praise_nums'], self['tags'], self['content'])
